...
int main()
{
  ...
  WordHitsChunkPtr bridge_head1 = make_shared<WordHitsChunk>(0);
  bridge_head1->strand = 1;
  bridge_head1->refStart_pos = 0;
  bridge_head1->refEnd_pos = 5;
  bridge_head1->queryStart_pos = 1;
  bridge_head1->queryEnd_pos = 6;
  bridge_head1->gapMM.num_mismatch = 6;
  bridge_head1->gapMM.num_gapOpenRef = 1;
  bridge_head1->gapMM.num_gapExtRef = 2;
  bridge_head1->gapMM.num_gapOpenQuery = 3;
  bridge_head1->gapMM.num_gapExtQuery = 4;

  WordHitsChunkPtr bridge_head2 = make_shared<WordHitsChunk>(1);
  bridge_head2->strand = 1;
  bridge_head2->refStart_pos = 2;
  bridge_head2->refEnd_pos = 7;
  bridge_head2->queryStart_pos = 1;
  bridge_head2->queryEnd_pos = 7;
  bridge_head2->gapMM.num_mismatch = 7;
  bridge_head2->gapMM.num_gapOpenRef = 8;
  bridge_head2->gapMM.num_gapExtRef = 9;
  bridge_head2->gapMM.num_gapOpenQuery = 10;
  bridge_head2->gapMM.num_gapExtQuery = 11;

  WordHitsChunkPtr bridge_tail1 = make_shared<WordHitsChunk>(2);
  ...
  WordHitsChunkPtr bridge_tail2 = make_shared<WordHitsChunk>(3);
  ...
  group_bridge1->head_chunk = bridge_head1;
  ...
  group_bridge2->head_chunk = bridge_head2;
